...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    public partial class ReservationOrderResponseCollection : ArmCollection, IEnumerable<ReservationOrderResponseResource>, IAsyncEnumerable<ReservationOrderResponseResource>
    {
        ...
        {
            _reservationOrderResponseReservationOrderClientDiagnostics = new ClientDiagnostics("Microsoft.Azure.Management.Reservations", ReservationOrderResponseResource.ResourceType.Namespace, Diagnostics);
