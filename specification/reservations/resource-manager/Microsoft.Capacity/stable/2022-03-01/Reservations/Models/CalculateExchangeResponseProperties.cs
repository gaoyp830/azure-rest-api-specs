...
namespace Microsoft.Azure.Management.Reservations.Models
{
    ...
    public partial class CalculateExchangeResponseProperties
    {
        ...
        internal CalculateExchangeResponseProperties(string sessionId, Price netPayable, Price refundsTotal, Price purchasesTotal, IReadOnlyList<ReservationToPurchaseCalculateExchange> reservationsToPurchase, IReadOnlyList<ReservationToExchange> reservationsToExchange, ExchangePolicyErrors policyResult)
        {
            SessionId = sessionId;
