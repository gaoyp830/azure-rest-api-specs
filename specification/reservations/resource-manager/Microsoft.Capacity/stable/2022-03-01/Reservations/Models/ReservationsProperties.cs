...
namespace Microsoft.Azure.Management.Reservations.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ReservationsProperties. </summary>
        ...
        /// <param name="effectiveOn"> DateTime of the Reservation starting when this version is effective from. </param>
        ...
        internal ReservationsProperties(ReservedResourceType? reservedResourceType, InstanceFlexibility? instanceFlexibility, string displayName, IReadOnlyList<string> appliedScopes, AppliedScopeType? appliedScopeType, bool? archived, string capabilities, int? quantity, ProvisioningState? provisioningState, DateTimeOffset? effectiveOn, DateTimeOffset? benefitStartOn, DateTimeOffset? lastUpdatedOn, DateTimeOffset? expiryOn, string skuDescription, ExtendedStatusInfo extendedStatusInfo, ReservationBillingPlan? billingPlan, string displayProvisioningState, string provisioningSubState, DateTimeOffset? purchaseOn, ReservationSplitProperties splitProperties, ReservationMergeProperties mergeProperties, string billingScopeId, bool? renew, string renewSource, string renewDestination, RenewPropertiesResponse renewProperties, ReservationTerm? term, string userFriendlyAppliedScopeType, string userFriendlyRenewState, ReservationsPropertiesUtilization utilization)
        {
        ...
        public RenewPropertiesResponse RenewProperties { get; }
        ...
        public ReservationsPropertiesUtilization Utilization { get; }
    }
}
