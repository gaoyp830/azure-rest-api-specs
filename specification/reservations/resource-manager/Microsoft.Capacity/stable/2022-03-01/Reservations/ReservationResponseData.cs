...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    public partial class ReservationResponseData : ResourceData
    {
        ...
        internal ReservationResponseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string location, int? etag, ReservationsSkuName sku, ReservationsProperties properties, string kind) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Etag = etag;
            Sku = sku;
